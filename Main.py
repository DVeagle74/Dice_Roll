...
def calc_num_total():
    total_num_dice.set(counter_d4.get() + counter_d6.get())
...
def calc_roll_total():
    total_roll.set(total_d4.get() + total_d6.get())        
